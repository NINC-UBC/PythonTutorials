...
np.sum(dat[50,])
np.sum(dat[50,0::2])+np.sum(dat[50,1::2])
...
min_val=np.amin(the_fourth)
min_ind=np.argmin(the_fourth)
the_fourth[min_ind]
the_fourth=np.delete(the_fourth,min_ind)
...
min_ind=np.argmin(np.absolute(the_fourth-1))
the_fourth[min_ind]
the_fourth=np.delete(the_fourth,min_ind)
