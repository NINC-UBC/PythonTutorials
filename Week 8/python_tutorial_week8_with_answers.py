...
myfile_out=myfile_out +'_RESULTS.npy'
...
a_file=file_prefix+str(4)+file_suffix

# or the 3rd...

another_file=file_prefix+str(3)+file_suffix
...
all_dat=np.zeros((n_files,s[0],s[1]))
