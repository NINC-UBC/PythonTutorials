...
increment of 0.1 and end at 3. Use numpy function arange.
"""
...
that by the plotting command.  Highlight power and run together.
"""
...
x values. Note plot accepts multiple input arguments (x then y)
"""
...
as a y axis label using the commands xlabel and ylabel. These are analogous
to title.
"""
...
did above.  Simply follow it by another plot command to overplot y2.
"""
...
correct places in the larger matrix. Bonus: Can you do it without the loop?
...
14. Make three variables called b1, b2 & b3 assign one the values 10, 5, & 7.5.
"""
